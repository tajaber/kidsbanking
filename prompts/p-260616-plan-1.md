Founder context:
- Budget: low 
- Target launch region: global
- Target first users: families 
- Preferred stack (if any): React Native 
- Business goal: validate demand, launch MVP, get first paying customers

Act as a senior startup strategist, mobile product manager, solutions architect, UX strategist, and go-to-market advisor.

I want you to create a **comprehensive, highly detailed, step-by-step execution plan and practical guide** for building and launching a mobile app called **KidsBanking**.
...
Create a **full end-to-end guide** from **idea to first customer**, written for a founder/team that wants to build this product seriously.

I want the output to be **deep, structured, practical, step-by-step, and decision-oriented**, not generic advice.

## Required output structure

Please organize the response into the following major sections and go into depth in each:

### 1) Executive summary
- Summarize the product concept
- Explain why it may be valuable
- Identify primary target users
- Identify biggest risks and opportunities
- Clearly distinguish MVP vs future phases

### 2) Problem definition and value proposition
- What exact problems does KidsBanking solve?
- For parents
- For kids
- For teachers/coaches/schools
- Emotional, behavioral, educational, and organizational value
- Suggested positioning statements
- Unique value proposition compared with chore/reward apps

### 3) Market research and validation plan
Create a step-by-step validation approach before building too much.
Include:
- Target customer segments
- Ideal customer profiles
- Jobs-to-be-done
- Competitor categories and competitor analysis framework
- What assumptions must be validated first
- Interview questions for parents, teachers, schools, and kids’ guardians
- Survey ideas
- Landing page test ideas
- Concierge MVP / no-code MVP options
- How to measure demand before full development

## 3A) Competitor landscape analysis (NEW SECTION)

Perform **thorough market research on existing competitors**. This is critical.

### Identify and categorize competitors:
- Direct competitors (chore/reward apps for kids)
- Indirect competitors (habit trackers, gamification apps, family apps)
- Financial/kids banking adjacent apps (ONLY where relevant)
...
- Strengths
- Weaknesses
- What they do well in UX and engagement
- Gaps or missed opportunities

### Include:
- A comparison table across competitors
- Key patterns in the market
- What users like/dislike (if known, summarize from common feedback trends—not fabricated specifics)
- Differentiation opportunities for KidsBanking

### Deliver insights:
- What to copy (best practices)
- What to avoid
- Where KidsBanking can win
...
- Teacher
- Independent coach
- School moderator/admin
- Kid user (only from a product behavior perspective, not inappropriately personalized)
...
- Phase 1: MVP
- Phase 2: enhanced parent-kid experience
- Phase 3: teacher/school ecosystem
- Phase 4: store/merchant redemption
For each phase:
- Objectives
- Included features
- Excluded features
